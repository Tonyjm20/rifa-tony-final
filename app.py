...
# IMPORTANTE: Para que los participantes no se borren entre pestañas, 
# en el futuro necesitarás Google Sheets. Por ahora, mantén tu PC encendida.
...
# Determinamos qué ver según la URL
if es_publico:
    menu = "🎟️ Registro"
else:
...
# ==========================================
    ...
    if st.text_input("Contraseña", type="password") == CLAVE_MAESTRO:
        ...
        st.info("Link para seguidores: `https://rifa-tony-final-n6sp2uzx2pwyrnx4gkkn8r.streamlit.app?modo=registro`")
